...
if nargin<1, test_ss_freqfilter; return; end
if nargin<3, flo = []; end
if nargin<4, fhi = []; end
...
%d = loaddata; d.A = ss_freqfilter(d.A,d.samplefreq,300,10000); viewraw(d);
